...
## Natalya Nosova <Badge type="info" text="1" />, Andrey Fedyaevskiy <Badge type="info" text="2" />, Anna Lyubarova <Badge type="info" text="1" />

1. Komarov Botanical Institute RAS, St. Petersburg
2. Palynology and Stratigraphy Lab 'PalyStrat' LLP, Almaty, Kazakhstan

natanosova@gmail.com
...
## Robert A. Spicer <Badge type="info" text="1,2,3" />
...
Томский государственный университет, лаборатория континентальных экосистем мезозоя и кайнозоя.

burkanova@ggf.tsu.ru
...
Ботанический ин-т им. В. Л. Комарова РАН, Санкт-Петербург

svetlana.popova@binran.ru
